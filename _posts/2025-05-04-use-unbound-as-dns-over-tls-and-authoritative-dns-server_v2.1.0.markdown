---
layout: post
title: "docker-stafwag-unbound v2.1.0 released: Use unbound as an DNS-over-TLS resolver and authoritative DNS server"
date: 2025-05-04 16:01:01 +0100
comments: true
categories: [ unbound, stubby, dns, container, docker, debian, linux ] 
...
[Unbound](https://www.nlnetlabs.nl/projects/unbound/about/) is a popular DNS resolver, that has native DNS-over-TLS support.
<br />&nbsp;<br />

Unbound and [Stubby](https://dnsprivacy.org/dns_privacy_daemon_-_stubby/) were among the first resolvers to implement DNS-over-TLS.
...
* [https://stafwag.github.io/blog/blog/2018/10/07/dns-privacy-with-stubby-part-2-freebsd/](https://stafwag.github.io/blog/blog/2018/10/07/dns-privacy-with-stubby-part-2-freebsd/)

The implementation status of DNS-over-TLS and other DNS privacy options is available at: [https://dnsprivacy.org/](https://dnsprivacy.org/).

See [https://dnsprivacy.org/implementation_status/](https://dnsprivacy.org/implementation_status/) for more details.
...
I recently updated the container, the latest version (2.1.0) is available at: [https://github.com/stafwag/docker-stafwag-unbound](https://github.com/stafwag/docker-stafwag-unbound)

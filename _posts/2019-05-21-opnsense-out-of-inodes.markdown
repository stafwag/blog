...
<a href="{{ '/images/opnsense_out_of_inodes.jpg' | relative_url }}"><img src="{{ '/images/opnsense_out_of_inodes.jpg' | relative_url }}" class="left" width="500" height="382" alt="opnsense with no inodes" /></a>

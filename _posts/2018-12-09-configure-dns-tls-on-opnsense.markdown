...
<img src="{{ '/images/Logo_OPNsense.jpg'  | remove_first:'/' | absolute_url }}" class="right" width="300" height="85" alt="Logo_OPNsense.jpg" /> 
...
<a href="{{ '/images/opnsense_enable_dns_tls.png' | remove_first:'/' | absolute_url }}"><img src="{{ '/images/opnsense_enable_dns_tls.png' | remove_first:'/' | absolute_url }}" class="left" width="300" height="458" alt="opnsense_enable_dns_tls.png" /> </a>
...
<a href="{{ '/images/opnsense_set_dns.png' | remove_first:'/' | absolute_url }}"><img src="{{ '/images/opnsense_set_dns.png' | remove_first:'/' | absolute_url }}" class="right" width="300" height="693" alt="opnsense_set_dns.png" /> </a>
